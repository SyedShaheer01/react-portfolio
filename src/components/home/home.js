  ...
  return (
    <div className='home-parent'>
      ...
      <div className='my-about' data-aos="fade-right">
        ...
        <h1>Hi, I'm <span>SYED SHAHEER ZIA</span></h1>
        <h2>

      <Typewriter
        words={["Mern Stack Developer", "Frontend Developer","React/Next.js Developer"]}
        delaySpeed={1500}
        typeSpeed={100}
        loop={false}
        cursor={true}
        ...
        <p>I’m a Mern-Stack and Front-end React.JS ,
          <br/>
      ...
      <div className='home-right' data-aos="fade-left">
        <img width={450} src={Hello} alt=''/>
      </div>


      <div className="custom-shape-divider-bottom-1722341926">
